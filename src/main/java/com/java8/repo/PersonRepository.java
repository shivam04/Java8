...
public class PersonRepository {
    public static List<Person> getAllPersons() {
        ...
        Person p4 = new Person("Nancy", 130, 4900, "Female", 2, Arrays.asList("Cricket", "Swimming", "Driving"));
        Person p5 = new Person("Harper", 125, 9000, "Female", 2, Arrays.asList("Football", "Swimming", "Cricket"));
